...
//   { "HEADER_ICON_BGCOLOR", HEADER_ICON_BGCOLOR },
...
#if defined (PCBNV14)
  { "EVT_PAGEUP_FIRST",  EVT_KEY_FIRST(KEY_PGUP) },
  { "EVT_PAGEUP_LONG",  EVT_KEY_LONG(KEY_PGUP) },
  { "EVT_PAGEUP_BREAK",  EVT_KEY_BREAK(KEY_PGUP) },
  ...
  { "EVT_TELEM_FIRST",  EVT_KEY_FIRST(KEY_TELEM) },
  { "EVT_TELEM_LONG",  EVT_KEY_LONG(KEY_TELEM) },
  { "EVT_TELEM_BREAK",  EVT_KEY_BREAK(KEY_TELEM) },

  { "EVT_MENU_FIRST",  EVT_KEY_FIRST(KEY_MENU) },
  { "EVT_MENU_LONG",  EVT_KEY_LONG(KEY_MENU) },
  { "EVT_MENU_BREAK",  EVT_KEY_BREAK(KEY_MENU) },
  ...
  { "EVT_PLUS_LONG", EVT_KEY_LONG(KEY_UP) },
  { "EVT_PLUS_REPT", EVT_KEY_REPT(KEY_UP) },
  { "EVT_MINUS_FIRST", EVT_KEY_FIRST(KEY_DOWN) },
  { "EVT_MINUS_BREAK", EVT_KEY_BREAK(KEY_DOWN) },
  { "EVT_MINUS_LONG", EVT_KEY_LONG(KEY_DOWN) },
  { "EVT_MINUS_REPT", EVT_KEY_REPT(KEY_DOWN) },

  { "EVT_SLIDE_UP", EVT_TOUCH(TOUCH_SLIDE_UP) },
  { "EVT_SLIDE_DOWN", EVT_TOUCH(TOUCH_SLIDE_DOWN) },
