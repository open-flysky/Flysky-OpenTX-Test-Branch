...
/*
  { "EVT_PLUS_FIRST", EVT_KEY_FIRST(KEY_RIGHT) },
  { "EVT_PLUS_REPT", EVT_KEY_REPT(KEY_RIGHT) },
  { "EVT_PLUS_BREAK", EVT_KEY_BREAK(KEY_RIGHT) },

  { "EVT_MINUS_FIRST", EVT_KEY_FIRST(KEY_LEFT) },
  { "EVT_MINUS_REPT", EVT_KEY_REPT(KEY_LEFT) },
  { "EVT_MINUS_BREAK", EVT_KEY_BREAK(KEY_LEFT) },
*/
  /*
  { "EVT_RIGHT_FIRST", EVT_KEY_FIRST(KEY_RIGHT) },
  { "EVT_RIGHT_REPT", EVT_KEY_REPT(KEY_RIGHT) },
