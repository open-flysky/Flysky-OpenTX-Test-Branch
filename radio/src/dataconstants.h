...
#elif defined(PCBX7) || defined(PCBXLITE) || defined(RADIO_T16)
...
#if defined(HARDWARE_INTERNAL_MODULE)
  #define IS_MODULE_ENABLED(x)         (x==INTERNAL_MODULE ? IS_INTERNAL_MODULE_ENABLED() : x==EXTERNAL_MODULE ? IS_EXTERNAL_MODULE_ENABLED() : false)
#else
  #define IS_MODULE_ENABLED(x)         (x==EXTERNAL_MODULE ? IS_EXTERNAL_MODULE_ENABLED() : false)
#endif
