...
const pm_char STR_OPEN9X[] PROGMEM =
    ...
    ISTR(BLUETOOTH_BAUDRATE)
    ISTR(BLUETOOTH_PLATFORMS)
#endif
    ISTR(VANTENNATYPES)
#endif
...
const pm_char STR_TURN_OFF_RECEIVER[] PROGMEM = TR_TURN_OFF_RECEIVER;
const pm_char STR_TURN_OFF_RECEIVER_MESSAGE[] PROGMEM = TR_TURN_OFF_RECEIVER_MESSAGE;
const pm_char STR_STOPPING[] PROGMEM = TR_STOPPING;
const pm_char STR_MENU_SPECTRUM_ANALYSER[] PROGMEM = TR_MENU_SPECTRUM_ANALYSER;
...
const pm_char STR_DISABLE_CH_MAP[] PROGMEM = TR_DISABLE_CH_MAP;
const pm_char STR_DISABLE_TELEM[] PROGMEM = TR_DISABLE_TELEM;
const pm_char STR_MULTI_LNA_DISABLE[] PROGMEM = TR_MULTI_LNA_DISABLE;
const pm_char STR_MODULE_UPGRADE_ALERT[] PROGMEM = TR_MODULE_UPGRADE_ALERT;
const pm_char STR_MODULE_UPGRADE[] PROGMEM = TR_MODULE_UPGRADE;
const pm_char STR_MULTI_MAX_THROW[] PROGMEM = TR_MULTI_MAX_THROW;
const pm_char STR_MULTI_RFCHAN[] PROGMEM = TR_MULTI_RFCHAN;
const pm_char STR_NEEDS_FILE[] PROGMEM = TR_NEEDS_FILE;
const pm_char STR_EXT_MULTI_SPEC[] PROGMEM = TR_EXT_MULTI_SPEC;
const pm_char STR_INT_MULTI_SPEC[] PROGMEM = TR_INT_MULTI_SPEC;
const pm_char STR_FLASH_EXTERNAL_MULTI[] PROGMEM = TR_FLASH_EXTERNAL_MULTI;
const pm_char STR_FLASH_EXTERNAL_ELRS[] PROGMEM = TR_FLASH_EXTERNAL_ELRS;
const pm_char STR_FLASH_WRITE[] PROGMEM = TR_FLASH_WRITE;
#if LCD_W < 212
const pm_char STR_SUBTYPE[] PROGMEM = TR_SUBTYPE;
#endif
#endif

const pm_char STR_DEVICE_RESET[] PROGMEM = TR_DEVICE_RESET;
const pm_char STR_FIRMWARE_UPDATE_SUCCESS[] PROGMEM = TR_FIRMWARE_UPDATE_SUCCESS;
const pm_char STR_RFPOWER_AFHDS2[] PROGMEM = TR_RFPOWER_AFHDS2;
const pm_char STR_FW_VERSION[] PROGMEM = TR_FW_VERSION;

#if defined(AFHDS3)
const pm_char STR_RFPOWER_AFHDS3[] PROGMEM = TR_RFPOWER_AFHDS3;
const pm_char STR_BIND_POWER_AFHDS3[] PROGMEM = TR_RFPOWER_AFHDS3;
const pm_char STR_ACTUAL_RF_POWER[] PROGMEM = TR_ACTUAL_RF_POWER;
const pm_char STR_POWER_SOURCE[] PROGMEM = TR_POWER_SOURCE;
const pm_char STR_AFHDS3_ONE_TO_ONE_TELEMETRY[] PROGMEM = TR_AFHDS3_ONE_TO_ONE_TELEMETRY;
const pm_char STR_AFHDS3_ONE_TO_MANY[] PROGMEM = TR_AFHDS3_ONE_TO_MANY;
#endif
const pm_char STR_RESET_BTN[] PROGMEM = TR_RESET_BTN;
const pm_char STR_GHOST_MENU_LABEL[] PROGMEM = TR_GHOST_MENU_LABEL;
...
const pm_char STR_ENABLE[] PROGMEM = TR_ENABLE;
  ...
  const pm_char STR_BLUETOOTH_PLATFORM[] PROGMEM = TR_BLUETOOTH_PLATFORM;
#endif
