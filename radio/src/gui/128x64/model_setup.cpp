...
#define PORT_CHANNELS_ROWS(x)          (x==EXTERNAL_MODULE ? MODULE_CHANNELS_ROWS(EXTERNAL_MODULE) : 0)
  ...
  for (uint8_t i=0; i<NUM_BODY_LINES; ++i) {
    ...
    switch (k) {
      ...
      case ITEM_MODEL_SETUP_EXTERNAL_MODULE_STATUS: {
        ...
        char statusText[64];
        getMultiModuleStatus(CURRENT_MODULE_EDITED(k)).getStatusString(statusText);
      ...
      case ITEM_MODEL_SETUP_EXTERNAL_MODULE_SYNCSTATUS: {
        ...
        char statusText[64];
        getMultiSyncStatus(CURRENT_MODULE_EDITED(k)).getRefreshString(statusText);
        lcdDrawText(MODEL_SETUP_2ND_COLUMN, y, statusText);
        break;
      }
#endif
