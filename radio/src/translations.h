...
#if defined(PCBHORUS)
  #define TR_VTRAINERMODES     TR_VTRAINER_OFF TR_VTRAINER_MASTER_JACK TR_VTRAINER_SLAVE_JACK TR_VTRAINER_MASTER_BATTERY TR_VTRAINER_BLUETOOTH
#elif defined(PCBX9E)
  #define TR_VTRAINERMODES     TR_VTRAINER_OFF TR_VTRAINER_MASTER_JACK TR_VTRAINER_SLAVE_JACK TR_VTRAINER_MASTER_SBUS_MODULE TR_VTRAINER_MASTER_CPPM_MODULE TR_VTRAINER_MASTER_BATTERY TR_VTRAINER_BLUETOOTH
#elif defined(PCBTARANIS) && defined(BLUETOOTH)
  #define TR_VTRAINERMODES     TR_VTRAINER_OFF TR_VTRAINER_MASTER_JACK TR_VTRAINER_SLAVE_JACK TR_VTRAINER_MASTER_SBUS_MODULE TR_VTRAINER_MASTER_CPPM_MODULE TR_VTRAINER_MASTER_BATTERY TR_VTRAINER_BLUETOOTH
#elif defined(PCBTARANIS)
  #define TR_VTRAINERMODES     TR_VTRAINER_OFF TR_VTRAINER_MASTER_JACK TR_VTRAINER_SLAVE_JACK TR_VTRAINER_MASTER_SBUS_MODULE TR_VTRAINER_MASTER_CPPM_MODULE TR_VTRAINER_MASTER_BATTERY
#elif defined(PCBNV14)
  #define TR_VTRAINERMODES     TR_VTRAINER_OFF TR_VTRAINER_MASTER_JACK TR_VTRAINER_SLAVE_JACK TR_VTRAINER_BLUETOOTH
#elif defined(CPUARM)
  #define TR_VTRAINERMODES     TR_VTRAINER_OFF TR_VTRAINER_MASTER_JACK TR_VTRAINER_SLAVE_JACK TR_VTRAINER_MASTER_CPPM_MODULE TR_VTRAINER_MASTER_BATTERY
#endif
...
#define OFS_DATETIME            (OFS_VTMRMODES + sizeof(TR_VTMRMODES))
  ...
  #define OFS_FLYSKY_MODES      (OFS_FLYSKY_PROTOCOLS + sizeof(TR_FLYSKY_PROTOCOLS))
  #define OFS_DSM_PROTOCOLS     (OFS_FLYSKY_MODES + sizeof(TR_FLYSKY_MODES))
  ...
  #define OFS_BLUETOOTH_BAUDRATE  (OFS_BLUETOOTH_MODES + sizeof(TR_BLUETOOTH_MODES))
  #define OFS_BLUETOOTH_PLATFORMS (OFS_BLUETOOTH_BAUDRATE + sizeof(TR_BLUETOOTH_BAUDRATE))
  #define OFS_VANTENNATYPES       (OFS_BLUETOOTH_PLATFORMS + sizeof(TR_BLUETOOTH_PLATFORMS))
#else
...
#define STR_VTMRMODES           (STR_OPEN9X + OFS_VTMRMODES)
  ...
  #define STR_FLYSKY_MODES      (STR_OPEN9X + OFS_FLYSKY_MODES)
...
extern const pm_char STR_BLUETOOTH_PLATFORM[];
#define STR_BLUETOOTH_MODES     (STR_OPEN9X + OFS_BLUETOOTH_MODES)
#define STR_BLUETOOTH_PLATFORMS (STR_OPEN9X + OFS_BLUETOOTH_PLATFORMS)
#define STR_BLUETOOTH_BAUDRATE  (STR_OPEN9X + OFS_BLUETOOTH_BAUDRATE)
