...
void trainerSendNextFrame()
{
  TRAINER_OUT_COUNTER_REGISTER = GET_PPM_DELAY(TRAINER_MODULE) * 2;
  TRAINER_TIMER->CCER = TRAINER_OUT_CCER | (GET_PPM_POLARITY(TRAINER_MODULE) ? 0 : TRAINER_CCER_POLARYTY);
