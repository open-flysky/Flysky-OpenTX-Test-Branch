...
void pwrInit()
{
  ...
  GPIO_SetBits(BLUETOOTH_MODE_GPIO, BLUETOOTH_MODE_GPIO_PIN);
  GPIO_InitStructure.GPIO_Pin = BLUETOOTH_MODE_GPIO_PIN;
  GPIO_Init(BLUETOOTH_MODE_GPIO, &GPIO_InitStructure);
